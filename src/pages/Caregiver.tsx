...
export default function Caregiver() {
  ...
  return (
    <>
      ...
      {/* PremiumGate renders a bare fragment when entitled, so PageBody's own
          spacing still applies to the sections below. */}
      <PageBody className="space-y-9">
        <PremiumGate feature="caregiver-access" title="Caregiver delegation">
          {/* --- Scope --------------------------------------------------------- */}
          <section>
            <SectionHeader
              eyebrow="Your access"
